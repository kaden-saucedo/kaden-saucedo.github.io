...
At the moment, my main project focuses on degree $4$ $$4$$ \(4\) \(\(4\)\) del Pezzo surfaces: I am working to understand how $\kappa$ \(\kappa\)-classes generate and intersect in the Chow ring of the moduli space, and how these classes behave under variations of weights on the boundary (in the spirit of Hassett’s weighted stable curves).
